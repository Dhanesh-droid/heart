...
#icon1
image_icon=PhotoImage(file=r"heart-main\Images\icon.png")
root.iconphoto(False,image_icon)


##header section 2
logo=PhotoImage(file=r"heart-main\Images\header.png")
...
Entry_image=PhotoImage(file=r"heart-main\Images\Rounded Rectangle 1.png")
Entry_image2=PhotoImage(file=r"heart-main\Images\Rounded Rectangle 2.png")
...
thelach_entry = Entry(Detail_entry, textvariable=thelach, width=10, font="arial 15", bg="#ededed", fg="#222222", bd=0)
...
# Load the image
# Fix the typo 'backgroung' to 'background'
report_background = Label(root, bg=background)  # No image specified
...
graph_image = PhotoImage(file=r"heart-main\Images\graph.png")
...
###############################################Button######################################################################
analysis_button=PhotoImage(file=r"heart-main\Images\Analysis.png")
...
info_button = PhotoImage(file=r"heart-main\Images\info.png")
Button(root,image=info_button, bd=0, bg=background, cursor='hand2').place(x=10, y=240)

################################################Save Button################################################################

save_button=PhotoImage(file=r"heart-main\Images\save.png")
...
smoking_icon=PhotoImage(file=r"heart-main\Images\smoker.png")
non_smoking_icon=PhotoImage(file=r"heart-main\Images\non-smoker.png")
...
logout_icon=PhotoImage(file=r"heart-main\Images\logout.png")
